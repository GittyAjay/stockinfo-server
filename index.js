...
const swaggerDocs = require('./app/swaggerConfig.js');
...
// Import routes
const stockRoutes = require('./app/routes/stockRoutes.js');
const selectedStock = require('./app/routes/selectedStock.js');
const newsRoutes = require('./app/routes/newsRoutes.js');
const extractRoutes = require('./app/routes/extractRoutes.js');
